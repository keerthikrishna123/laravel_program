                ...
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <li>
                        ...
                        <!-- <li class="nav-item"><a class="nav-link" href="/create_merchandiser"><i class="ti-control-record"></i>Banner section</a></li> -->
                            <li class="nav-item"><a class="nav-link" href="/view1"><i class="ti-control-record"></i>View users</a></li>
                            <li class="nav-item"><a class="nav-link" href="/banner"><i class="ti-control-record"></i>View Blocked users</a></li>
...
<td>
                                                <a href="/block/{{$list1->id}}">
                                                <i class="typcn typcn-eye vrt" title="View profile"></i>
