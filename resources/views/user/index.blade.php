        ...
        <div class="left-sidenav">
            ...
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <li>
                        <a href="index"><i data-feather="grid" class="align-self-center menu-icon"></i><span>My Profile</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                          <td>Name</td>  <td>{{$list1->name}}</td>
</tr>
<tr>
                                        
                                            <td>Email</td><td>{{$list1->email}}</td>
</tr>
<tr>
